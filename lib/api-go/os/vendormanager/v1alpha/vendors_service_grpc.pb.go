...
const (
	Vendors_CreateVendor_FullMethodName = "/datum.os.vendormanager.v1alpha.Vendors/CreateVendor"
	Vendors_GetVendor_FullMethodName    = "/datum.os.vendormanager.v1alpha.Vendors/GetVendor"
	Vendors_ListVendors_FullMethodName  = "/datum.os.vendormanager.v1alpha.Vendors/ListVendors"
	Vendors_UpdateVendor_FullMethodName = "/datum.os.vendormanager.v1alpha.Vendors/UpdateVendor"
	Vendors_DeleteVendor_FullMethodName = "/datum.os.vendormanager.v1alpha.Vendors/DeleteVendor"
)
...
type VendorsClient interface {
	...
	CreateVendor(ctx context.Context, in *CreateVendorRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error)
	...
	UpdateVendor(ctx context.Context, in *UpdateVendorRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error)
	// DeleteVendor deletes a Vendor by name.
	DeleteVendor(ctx context.Context, in *DeleteVendorRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error)
}
...
func (c *vendorsClient) CreateVendor(ctx context.Context, in *CreateVendorRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
...
func (c *vendorsClient) UpdateVendor(ctx context.Context, in *UpdateVendorRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(longrunningpb.Operation)
...
func (c *vendorsClient) DeleteVendor(ctx context.Context, in *DeleteVendorRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(longrunningpb.Operation)
...
type VendorsServer interface {
	// CreateVendor creates a new Vendor.
	CreateVendor(context.Context, *CreateVendorRequest) (*longrunningpb.Operation, error)
	// GetVendor gets a Vendor by name.
	...
	// UpdateVendor updates a Vendor.
	UpdateVendor(context.Context, *UpdateVendorRequest) (*longrunningpb.Operation, error)
	// DeleteVendor deletes a Vendor by name.
	DeleteVendor(context.Context, *DeleteVendorRequest) (*longrunningpb.Operation, error)
...
func (UnimplementedVendorsServer) CreateVendor(context.Context, *CreateVendorRequest) (*longrunningpb.Operation, error) {
...
func (UnimplementedVendorsServer) UpdateVendor(context.Context, *UpdateVendorRequest) (*longrunningpb.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateVendor not implemented")
}
func (UnimplementedVendorsServer) DeleteVendor(context.Context, *DeleteVendorRequest) (*longrunningpb.Operation, error) {
...
var Vendors_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "datum.os.vendormanager.v1alpha.Vendors",
	...
	Metadata: "datum/os/vendormanager/v1alpha/vendors_service.proto",
}
