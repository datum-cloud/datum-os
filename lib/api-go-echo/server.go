...
type ServerInterface interface {
	...
	// (GET /v1/vendors)
	VendorsListVendors(ctx echo.Context, params VendorsListVendorsParams) error

	// (POST /v1/vendors)
	VendorsCreateVendor(ctx echo.Context, params VendorsCreateVendorParams) error

	// (DELETE /v1/vendors/{vendor})
	VendorsDeleteVendor(ctx echo.Context, vendor string) error

	// (GET /v1/vendors/{vendor})
	VendorsGetVendor(ctx echo.Context, vendor string) error

	// (PATCH /v1/vendors/{vendor})
	VendorsUpdateVendor(ctx echo.Context, vendor string, params VendorsUpdateVendorParams) error
}
...
// VendorsListVendors converts echo context to params.
func (w *ServerInterfaceWrapper) VendorsListVendors(ctx echo.Context) error {
	var err error
...
// VendorsCreateVendor converts echo context to params.
func (w *ServerInterfaceWrapper) VendorsCreateVendor(ctx echo.Context) error {
	var err error
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter vendorId: %s", err))
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter validateOnly: %s", err))
	}
...
// VendorsDeleteVendor converts echo context to params.
func (w *ServerInterfaceWrapper) VendorsDeleteVendor(ctx echo.Context) error {
	var err error
...
// VendorsGetVendor converts echo context to params.
func (w *ServerInterfaceWrapper) VendorsGetVendor(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "vendor" -------------
	var vendor string
...
// VendorsUpdateVendor converts echo context to params.
func (w *ServerInterfaceWrapper) VendorsUpdateVendor(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "vendor" -------------
	var vendor string
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter vendor.name: %s", err))
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter vendor.vendorId: %s", err))
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter vendor.uid: %s", err))
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter vendor.displayName: %s", err))
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter vendor.createTime: %s", err))
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter vendor.updateTime: %s", err))
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter vendor.deleteTime: %s", err))
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter vendor.reconciling: %s", err))
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter vendor.etag: %s", err))
	}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.GET(baseURL+"/v1/vendors", wrapper.VendorsListVendors)
	router.POST(baseURL+"/v1/vendors", wrapper.VendorsCreateVendor)
	router.DELETE(baseURL+"/v1/vendors/:vendor", wrapper.VendorsDeleteVendor)
	router.GET(baseURL+"/v1/vendors/:vendor", wrapper.VendorsGetVendor)
	router.PATCH(baseURL+"/v1/vendors/:vendor", wrapper.VendorsUpdateVendor)

}

type VendorsListVendorsRequestObject struct {
	Params VendorsListVendorsParams
}

type VendorsListVendorsResponseObject interface {
	VisitVendorsListVendorsResponse(w http.ResponseWriter) error
}

type VendorsListVendors200JSONResponse ListVendorsResponse

func (response VendorsListVendors200JSONResponse) VisitVendorsListVendorsResponse(w http.ResponseWriter) error {
...
type VendorsListVendorsdefaultJSONResponse struct {
	Body       Status
	StatusCode int
}

func (response VendorsListVendorsdefaultJSONResponse) VisitVendorsListVendorsResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
...
type VendorsCreateVendorRequestObject struct {
	Params VendorsCreateVendorParams
	Body   *VendorsCreateVendorJSONRequestBody
}

type VendorsCreateVendorResponseObject interface {
	VisitVendorsCreateVendorResponse(w http.ResponseWriter) error
}

type VendorsCreateVendor200JSONResponse Vendor

func (response VendorsCreateVendor200JSONResponse) VisitVendorsCreateVendorResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type VendorsCreateVendordefaultJSONResponse struct {
	Body       Status
	StatusCode int
}

func (response VendorsCreateVendordefaultJSONResponse) VisitVendorsCreateVendorResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(response.StatusCode)
...
type VendorsDeleteVendorRequestObject struct {
	Vendor string `json:"vendor"`
}

type VendorsDeleteVendorResponseObject interface {
	VisitVendorsDeleteVendorResponse(w http.ResponseWriter) error
}

type VendorsDeleteVendor200Response struct {
}

func (response VendorsDeleteVendor200Response) VisitVendorsDeleteVendorResponse(w http.ResponseWriter) error {
	w.WriteHeader(200)
	return nil
}

type VendorsDeleteVendordefaultJSONResponse struct {
	Body       Status
	StatusCode int
}

func (response VendorsDeleteVendordefaultJSONResponse) VisitVendorsDeleteVendorResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(response.StatusCode)
...
type VendorsGetVendorRequestObject struct {
	Vendor string `json:"vendor"`
}

type VendorsGetVendorResponseObject interface {
	VisitVendorsGetVendorResponse(w http.ResponseWriter) error
}

type VendorsGetVendor200JSONResponse Vendor

func (response VendorsGetVendor200JSONResponse) VisitVendorsGetVendorResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type VendorsGetVendordefaultJSONResponse struct {
	Body       Status
	StatusCode int
}

func (response VendorsGetVendordefaultJSONResponse) VisitVendorsGetVendorResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(response.StatusCode)
...
type VendorsUpdateVendorRequestObject struct {
	Vendor string `json:"vendor"`
	Params VendorsUpdateVendorParams
}

type VendorsUpdateVendorResponseObject interface {
	VisitVendorsUpdateVendorResponse(w http.ResponseWriter) error
}

type VendorsUpdateVendor200JSONResponse Vendor

func (response VendorsUpdateVendor200JSONResponse) VisitVendorsUpdateVendorResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type VendorsUpdateVendordefaultJSONResponse struct {
	Body       Status
	StatusCode int
}

func (response VendorsUpdateVendordefaultJSONResponse) VisitVendorsUpdateVendorResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(response.StatusCode)
...
type StrictServerInterface interface {
	...
	// (GET /v1/vendors)
	VendorsListVendors(ctx context.Context, request VendorsListVendorsRequestObject) (VendorsListVendorsResponseObject, error)

	// (POST /v1/vendors)
	VendorsCreateVendor(ctx context.Context, request VendorsCreateVendorRequestObject) (VendorsCreateVendorResponseObject, error)

	// (DELETE /v1/vendors/{vendor})
	VendorsDeleteVendor(ctx context.Context, request VendorsDeleteVendorRequestObject) (VendorsDeleteVendorResponseObject, error)

	// (GET /v1/vendors/{vendor})
	VendorsGetVendor(ctx context.Context, request VendorsGetVendorRequestObject) (VendorsGetVendorResponseObject, error)

	// (PATCH /v1/vendors/{vendor})
	VendorsUpdateVendor(ctx context.Context, request VendorsUpdateVendorRequestObject) (VendorsUpdateVendorResponseObject, error)
}
...
// VendorsListVendors operation middleware
func (sh *strictHandler) VendorsListVendors(ctx echo.Context, params VendorsListVendorsParams) error {
	var request VendorsListVendorsRequestObject

	request.Params = params

	handler := func(ctx echo.Context, request interface{}) (interface{}, error) {
		return sh.ssi.VendorsListVendors(ctx.Request().Context(), request.(VendorsListVendorsRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "VendorsListVendors")
	}
	...
	if err != nil {
		return err
	} else if validResponse, ok := response.(VendorsListVendorsResponseObject); ok {
		return validResponse.VisitVendorsListVendorsResponse(ctx.Response())
...
// VendorsCreateVendor operation middleware
func (sh *strictHandler) VendorsCreateVendor(ctx echo.Context, params VendorsCreateVendorParams) error {
	var request VendorsCreateVendorRequestObject

	request.Params = params

	var body VendorsCreateVendorJSONRequestBody
	...
	handler := func(ctx echo.Context, request interface{}) (interface{}, error) {
		return sh.ssi.VendorsCreateVendor(ctx.Request().Context(), request.(VendorsCreateVendorRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "VendorsCreateVendor")
	}
	...
	if err != nil {
		return err
	} else if validResponse, ok := response.(VendorsCreateVendorResponseObject); ok {
		return validResponse.VisitVendorsCreateVendorResponse(ctx.Response())
	} else if response != nil {
		return fmt.Errorf("unexpected response type: %T", response)
	}
	return nil
...
// VendorsDeleteVendor operation middleware
func (sh *strictHandler) VendorsDeleteVendor(ctx echo.Context, vendor string) error {
	var request VendorsDeleteVendorRequestObject

	request.Vendor = vendor

	handler := func(ctx echo.Context, request interface{}) (interface{}, error) {
		return sh.ssi.VendorsDeleteVendor(ctx.Request().Context(), request.(VendorsDeleteVendorRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "VendorsDeleteVendor")
	}
	...
	if err != nil {
		return err
	} else if validResponse, ok := response.(VendorsDeleteVendorResponseObject); ok {
		return validResponse.VisitVendorsDeleteVendorResponse(ctx.Response())
	} else if response != nil {
		return fmt.Errorf("unexpected response type: %T", response)
	}
	return nil
...
// VendorsGetVendor operation middleware
func (sh *strictHandler) VendorsGetVendor(ctx echo.Context, vendor string) error {
	var request VendorsGetVendorRequestObject

	request.Vendor = vendor

	handler := func(ctx echo.Context, request interface{}) (interface{}, error) {
		return sh.ssi.VendorsGetVendor(ctx.Request().Context(), request.(VendorsGetVendorRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "VendorsGetVendor")
	}
	...
	if err != nil {
		return err
	} else if validResponse, ok := response.(VendorsGetVendorResponseObject); ok {
		return validResponse.VisitVendorsGetVendorResponse(ctx.Response())
	} else if response != nil {
		return fmt.Errorf("unexpected response type: %T", response)
	}
	return nil
...
// VendorsUpdateVendor operation middleware
func (sh *strictHandler) VendorsUpdateVendor(ctx echo.Context, vendor string, params VendorsUpdateVendorParams) error {
	var request VendorsUpdateVendorRequestObject

	request.Vendor = vendor
	request.Params = params

	handler := func(ctx echo.Context, request interface{}) (interface{}, error) {
		return sh.ssi.VendorsUpdateVendor(ctx.Request().Context(), request.(VendorsUpdateVendorRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "VendorsUpdateVendor")
	}
	...
	if err != nil {
		return err
	} else if validResponse, ok := response.(VendorsUpdateVendorResponseObject); ok {
		return validResponse.VisitVendorsUpdateVendorResponse(ctx.Response())
	} else if response != nil {
		return fmt.Errorf("unexpected response type: %T", response)
	}
	return nil
