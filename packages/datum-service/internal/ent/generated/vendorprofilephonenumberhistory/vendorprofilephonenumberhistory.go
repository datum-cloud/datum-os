...
const (
	// Label holds the string label denoting the vendorprofilephonenumberhistory type in the database.
	Label = "vendor_profile_phone_number_history"
	...
	// Table holds the table name of the vendorprofilephonenumberhistory in the database.
	Table = "vendor_profile_phone_number_history"
)

// Columns holds all SQL columns for vendorprofilephonenumberhistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o enthistory.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("vendorprofilephonenumberhistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the VendorProfilePhoneNumberHistory queries.
