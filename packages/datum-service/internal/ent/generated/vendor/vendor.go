...
func VendorTypeValidator(vt enums.VendorType) error {
	...
	case "UNSPECIFIED", "PERSON", "CORPORATION":
		return nil
	default:
		return fmt.Errorf("vendor: invalid enum value for vendor_type field: %q", vt)
	}
}
...
func OnboardingStateValidator(os enums.OnboardingState) error {
	...
	case "UNSPECIFIED", "PENDING", "ACTIVE", "INACTIVE":
		return nil
	default:
		return fmt.Errorf("vendor: invalid enum value for onboarding_state field: %q", os)
	}
}
