...
const (
	// Label holds the string label denoting the vendorprofilehistory type in the database.
	Label = "vendor_profile_history"
...
// Columns holds all SQL columns for vendorprofilehistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
// OrderOption defines the ordering options for the VendorProfileHistory queries.
