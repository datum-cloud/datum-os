...
const (
	// Label holds the string label denoting the phonenumberhistory type in the database.
	Label = "phone_number_history"
	...
	// Table holds the table name of the phonenumberhistory in the database.
	Table = "phone_number_history"
)

// Columns holds all SQL columns for phonenumberhistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
// OrderOption defines the ordering options for the PhoneNumberHistory queries.
