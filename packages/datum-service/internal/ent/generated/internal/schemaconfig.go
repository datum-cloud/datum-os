...
type SchemaConfig struct {
	...
	VendorProfilePaymentPreference        string // VendorProfilePaymentPreference table.
	VendorProfilePaymentPreferenceHistory string // VendorProfilePaymentPreferenceHistory table.
