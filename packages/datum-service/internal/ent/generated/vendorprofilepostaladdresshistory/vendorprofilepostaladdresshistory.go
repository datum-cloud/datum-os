...
const (
	// Label holds the string label denoting the vendorprofilepostaladdresshistory type in the database.
	Label = "vendor_profile_postal_address_history"
	...
	// Table holds the table name of the vendorprofilepostaladdresshistory in the database.
	Table = "vendor_profile_postal_address_history"
)

// Columns holds all SQL columns for vendorprofilepostaladdresshistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o enthistory.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("vendorprofilepostaladdresshistory: invalid enum value for operation field: %q", o)
	}
}
...
func PostalAddressTypeValidator(pat enums.PostalAddressType) error {
	...
	case "MAILING", "BILLING", "PHYSICAL":
		return nil
	default:
		return fmt.Errorf("vendorprofilepostaladdresshistory: invalid enum value for postal_address_type field: %q", pat)
	}
}

// OrderOption defines the ordering options for the VendorProfilePostalAddressHistory queries.
