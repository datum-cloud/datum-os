...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			vendorprofilepaymentpreference.Table:        vendorprofilepaymentpreference.ValidColumn,
			vendorprofilepaymentpreferencehistory.Table: vendorprofilepaymentpreferencehistory.ValidColumn,
