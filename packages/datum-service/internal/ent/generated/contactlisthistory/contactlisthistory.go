...
const (
	// Label holds the string label denoting the contactlisthistory type in the database.
	Label = "contact_list_history"
	...
	// Table holds the table name of the contactlisthistory in the database.
	Table = "contact_list_history"
)

// Columns holds all SQL columns for contactlisthistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o enthistory.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("contactlisthistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the ContactListHistory queries.
