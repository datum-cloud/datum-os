...
const (
	// Label holds the string label denoting the contactlistmembershiphistory type in the database.
	Label = "contact_list_membership_history"
	...
	// Table holds the table name of the contactlistmembershiphistory in the database.
	Table = "contact_list_membership_history"
)

// Columns holds all SQL columns for contactlistmembershiphistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o enthistory.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("contactlistmembershiphistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the ContactListMembershipHistory queries.
