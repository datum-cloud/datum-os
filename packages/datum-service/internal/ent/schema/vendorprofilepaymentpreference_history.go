...
// VendorProfilePaymentPreferenceHistory holds the schema definition for the VendorProfilePaymentPreferenceHistory entity.
type VendorProfilePaymentPreferenceHistory struct {
	ent.Schema
}

// Annotations of the VendorProfilePaymentPreferenceHistory.
func (VendorProfilePaymentPreferenceHistory) Annotations() []schema.Annotation {
...
// Fields of the VendorProfilePaymentPreferenceHistory.
func (VendorProfilePaymentPreferenceHistory) Fields() []ent.Field {
	...
	mixins := VendorProfilePaymentPreference{}.Mixin()
	...
	original := VendorProfilePaymentPreference{}
...
// Indexes of the VendorProfilePaymentPreferenceHistory
func (VendorProfilePaymentPreferenceHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Interceptors of the VendorProfilePaymentPreferenceHistory
func (VendorProfilePaymentPreferenceHistory) Interceptors() []ent.Interceptor {
