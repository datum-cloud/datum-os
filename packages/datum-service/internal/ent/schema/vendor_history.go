...
// VendorHistory holds the schema definition for the VendorHistory entity.
type VendorHistory struct {
	ent.Schema
}

// Annotations of the VendorHistory.
func (VendorHistory) Annotations() []schema.Annotation {
...
// Fields of the VendorHistory.
func (VendorHistory) Fields() []ent.Field {
...
// Indexes of the VendorHistory
func (VendorHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Interceptors of the VendorHistory
func (VendorHistory) Interceptors() []ent.Interceptor {
