...
// PostalAddressHistory holds the schema definition for the PostalAddressHistory entity.
type PostalAddressHistory struct {
	ent.Schema
}

// Annotations of the PostalAddressHistory.
func (PostalAddressHistory) Annotations() []schema.Annotation {
...
// Fields of the PostalAddressHistory.
func (PostalAddressHistory) Fields() []ent.Field {
...
// Indexes of the PostalAddressHistory
func (PostalAddressHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Interceptors of the PostalAddressHistory
func (PostalAddressHistory) Interceptors() []ent.Interceptor {
