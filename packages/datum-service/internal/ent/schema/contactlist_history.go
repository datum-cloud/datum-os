...
// ContactListHistory holds the schema definition for the ContactListHistory entity.
type ContactListHistory struct {
	ent.Schema
}

// Annotations of the ContactListHistory.
func (ContactListHistory) Annotations() []schema.Annotation {
...
// Fields of the ContactListHistory.
func (ContactListHistory) Fields() []ent.Field {
...
// Indexes of the ContactListHistory
func (ContactListHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Interceptors of the ContactListHistory
func (ContactListHistory) Interceptors() []ent.Interceptor {
	return []ent.Interceptor{
		interceptors.HistoryAccess("audit_log_viewer", true, false),
	}
}

// Policy of the ContactListHistory
func (ContactListHistory) Policy() ent.Policy {
	return privacy.Policy{
		Query: privacy.QueryPolicy{
			privacy.ContactListHistoryQueryRuleFunc(func(ctx context.Context, q *generated.ContactListHistoryQuery) error {
