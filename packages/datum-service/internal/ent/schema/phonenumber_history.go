...
// PhoneNumberHistory holds the schema definition for the PhoneNumberHistory entity.
type PhoneNumberHistory struct {
	ent.Schema
}

// Annotations of the PhoneNumberHistory.
func (PhoneNumberHistory) Annotations() []schema.Annotation {
...
// Fields of the PhoneNumberHistory.
func (PhoneNumberHistory) Fields() []ent.Field {
...
// Indexes of the PhoneNumberHistory
func (PhoneNumberHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Interceptors of the PhoneNumberHistory
func (PhoneNumberHistory) Interceptors() []ent.Interceptor {
