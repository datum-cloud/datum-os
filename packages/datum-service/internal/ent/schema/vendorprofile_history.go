...
// VendorProfileHistory holds the schema definition for the VendorProfileHistory entity.
type VendorProfileHistory struct {
	ent.Schema
}

// Annotations of the VendorProfileHistory.
func (VendorProfileHistory) Annotations() []schema.Annotation {
...
// Fields of the VendorProfileHistory.
func (VendorProfileHistory) Fields() []ent.Field {
...
// Indexes of the VendorProfileHistory
func (VendorProfileHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Interceptors of the VendorProfileHistory
func (VendorProfileHistory) Interceptors() []ent.Interceptor {
