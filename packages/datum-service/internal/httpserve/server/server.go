...
import (
	...
	"github.com/datum-cloud/datum-os/internal/httpserve/services"
...
func (s *Server) StartEchoServer(ctx context.Context) error {
	...
	mw.InitMiddleware(&s.config.Handler)
	...
	// Register proto services generated by oapi-codegen, all services require auth middleware
	protoServices := services.NewServer()
	services.RegisterHandlers(srv.Echo, protoServices, mw.GetAuthMiddleware()...)
