...
import (
	...
	"github.com/datum-cloud/datum-os/pkg/geodetic/config"
	"github.com/datum-cloud/datum-os/pkg/geodetic/jsonschema/envparse"
)

// const values used for the schema generator
const (
	repoName       = "github.com/datum-cloud/datum-os/pkg/geodetic/"
	tagName        = "koanf"
	skipper        = "-"
	defaultTag     = "default"
