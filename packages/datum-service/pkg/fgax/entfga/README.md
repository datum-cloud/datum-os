...
```shell
go get github.com/datum-cloud/datum-os/pkg/fgax/entfga@latest
```
...
We take the security of our software products and services seriously, including all of the open source code repositories managed through our Github Organizations, such as [datum-cloud](https://github.com/datum-cloud). If you believe you have found a security vulnerability in any of our repositories, please report it to us through coordinated disclosure.
