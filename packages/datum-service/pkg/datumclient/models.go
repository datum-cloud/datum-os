...
// CreatePostalAddressInput is used for create PostalAddress object.
// Input was generated by ent.
...
// CreateVendorProfileInput is used for create VendorProfile object.
// Input was generated by ent.
...
// CreateVendorProfilePostalAddressInput is used for create VendorProfilePostalAddress object.
// Input was generated by ent.
...
type PostalAddressConnection struct {
	// A list of edges.
	Edges []*PostalAddressEdge `json:"edges,omitempty"`
	// Information to aid in pagination.
	PageInfo *PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int64 `json:"totalCount"`
...
type PostalAddressEdge struct {
	// The item at the end of the edge.
	Node *PostalAddress `json:"node,omitempty"`
	// A cursor for use in pagination.
	Cursor string `json:"cursor"`
}
...
func (PostalAddressHistory) IsNode() {}

// A connection to a list of items.
type PostalAddressHistoryConnection struct {
	// A list of edges.
	Edges []*PostalAddressHistoryEdge `json:"edges,omitempty"`
	// Information to aid in pagination.
	PageInfo *PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int64 `json:"totalCount"`
...
type PostalAddressHistoryEdge struct {
	// The item at the end of the edge.
	Node *PostalAddressHistory `json:"node,omitempty"`
	// A cursor for use in pagination.
	Cursor string `json:"cursor"`
}

// Ordering options for PostalAddressHistory connections
type PostalAddressHistoryOrder struct {
	// The ordering direction.
	Direction OrderDirection `json:"direction"`
	// The field by which to order PostalAddressHistories.
	Field PostalAddressHistoryOrderField `json:"field"`
}

// PostalAddressHistoryWhereInput is used for filtering PostalAddressHistory objects.
// Input was generated by ent.
...
// Ordering options for PostalAddress connections
type PostalAddressOrder struct {
	// The ordering direction.
	Direction OrderDirection `json:"direction"`
	// The field by which to order PostalAddresses.
...
// PostalAddressWhereInput is used for filtering PostalAddress objects.
// Input was generated by ent.
...
// UpdatePostalAddressInput is used for update PostalAddress object.
// Input was generated by ent.
type UpdatePostalAddressInput struct {
	...
	// BCP-47 language code of the contents of this address (if known).
	LanguageCode      *string `json:"languageCode,omitempty"`
	ClearLanguageCode *bool   `json:"clearLanguageCode,omitempty"`
	// Postal code of the address. Not all countries use or require postal codes to be present, but where they are used, they may trigger additional validation with other parts of the address (e.g. state/zip validation in the U.S.A.).
	PostalCode      *string `json:"postalCode,omitempty"`
	ClearPostalCode *bool   `json:"clearPostalCode,omitempty"`
	// Additional, country-specific, sorting code. This is not used in most regions.
	SortingCode      *string `json:"sortingCode,omitempty"`
	ClearSortingCode *bool   `json:"clearSortingCode,omitempty"`
	// Highest administrative subdivision which is used for postal addresses of a country or region. For example, this can be a state, a province, an oblast, or a prefecture.
	AdministrativeArea      *string `json:"administrativeArea,omitempty"`
	ClearAdministrativeArea *bool   `json:"clearAdministrativeArea,omitempty"`
	// Locality of the address. Generally refers to the city/town portion of the address. Examples: US city, IT comune, UK post town.
	Locality      *string `json:"locality,omitempty"`
	ClearLocality *bool   `json:"clearLocality,omitempty"`
	// Sublocality of the address. This is the neighborhood, district, or town.
	Sublocality      *string `json:"sublocality,omitempty"`
	ClearSublocality *bool   `json:"clearSublocality,omitempty"`
	// Unstructured address lines describing the lower levels of an address.
	AddressLines       []string `json:"addressLines,omitempty"`
	AppendAddressLines []string `json:"appendAddressLines,omitempty"`
	// Recipients of the address. This field may, under certain circumstances, contain multiline information. For example, it might contain 'care of' information.
	Recipients       []string `json:"recipients,omitempty"`
	AppendRecipients []string `json:"appendRecipients,omitempty"`
	// Organization of the address.
	Organization      *string  `json:"organization,omitempty"`
	ClearOrganization *bool    `json:"clearOrganization,omitempty"`
	OwnerID           *string  `json:"ownerID,omitempty"`
	...
	RemoveEventIDs    []string `json:"removeEventIDs,omitempty"`
	ClearEvents       *bool    `json:"clearEvents,omitempty"`
	AddProfileIDs     []string `json:"addProfileIDs,omitempty"`
	RemoveProfileIDs  []string `json:"removeProfileIDs,omitempty"`
...
// UpdateVendorProfileInput is used for update VendorProfile object.
// Input was generated by ent.
type UpdateVendorProfileInput struct {
	...
	// The Doing Business As (DBA) name of the Corporation
	DbaName      *string `json:"dbaName,omitempty"`
	ClearDbaName *bool   `json:"clearDbaName,omitempty"`
	// The description of the Corporation or Person and the services they provide
	Description      *string `json:"description,omitempty"`
	ClearDescription *bool   `json:"clearDescription,omitempty"`
	// The URL of the website of the Corporation or Person
	WebsiteURI             *string  `json:"websiteURI,omitempty"`
	ClearWebsiteURI        *bool    `json:"clearWebsiteURI,omitempty"`
	OwnerID                *string  `json:"ownerID,omitempty"`
	ClearOwner             *bool    `json:"clearOwner,omitempty"`
	AddPostalAddressIDs    []string `json:"addPostalAddressIDs,omitempty"`
	RemovePostalAddressIDs []string `json:"removePostalAddressIDs,omitempty"`
...
// UpdateVendorProfilePostalAddressInput is used for update VendorProfilePostalAddress object.
// Input was generated by ent.
...
type Vendor struct {
	...
	OwnerID         *string               `json:"ownerID,omitempty"`
	DisplayName     string                `json:"displayName"`
	VendorType      enums.VendorType      `json:"vendorType"`
	OnboardingState enums.OnboardingState `json:"onboardingState"`
	Owner           *Organization         `json:"owner,omitempty"`
...
type VendorConnection struct {
	// A list of edges.
	Edges []*VendorEdge `json:"edges,omitempty"`
	// Information to aid in pagination.
	PageInfo *PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int64 `json:"totalCount"`
...
type VendorEdge struct {
	// The item at the end of the edge.
	Node *Vendor `json:"node,omitempty"`
	// A cursor for use in pagination.
	Cursor string `json:"cursor"`
}
...
func (VendorHistory) IsNode() {}

// A connection to a list of items.
type VendorHistoryConnection struct {
	// A list of edges.
	Edges []*VendorHistoryEdge `json:"edges,omitempty"`
	// Information to aid in pagination.
	PageInfo *PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int64 `json:"totalCount"`
...
type VendorHistoryEdge struct {
	// The item at the end of the edge.
	Node *VendorHistory `json:"node,omitempty"`
	// A cursor for use in pagination.
	Cursor string `json:"cursor"`
}

// Ordering options for VendorHistory connections
type VendorHistoryOrder struct {
	// The ordering direction.
	Direction OrderDirection `json:"direction"`
	// The field by which to order VendorHistories.
	Field VendorHistoryOrderField `json:"field"`
}

// VendorHistoryWhereInput is used for filtering VendorHistory objects.
// Input was generated by ent.
...
type VendorProfileConnection struct {
	// A list of edges.
	Edges []*VendorProfileEdge `json:"edges,omitempty"`
	// Information to aid in pagination.
	PageInfo *PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int64 `json:"totalCount"`
...
type VendorProfileCreatePayload struct {
	...
	VendorProfile *VendorProfile `json:"vendorProfile"`
}
...
type VendorProfileEdge struct {
	// The item at the end of the edge.
	Node *VendorProfile `json:"node,omitempty"`
	// A cursor for use in pagination.
	Cursor string `json:"cursor"`
}
...
type VendorProfileHistoryConnection struct {
	// A list of edges.
	Edges []*VendorProfileHistoryEdge `json:"edges,omitempty"`
	// Information to aid in pagination.
	PageInfo *PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int64 `json:"totalCount"`
...
type VendorProfileHistoryEdge struct {
	// The item at the end of the edge.
	Node *VendorProfileHistory `json:"node,omitempty"`
	// A cursor for use in pagination.
	Cursor string `json:"cursor"`
}

// Ordering options for VendorProfileHistory connections
type VendorProfileHistoryOrder struct {
	// The ordering direction.
	Direction OrderDirection `json:"direction"`
	// The field by which to order VendorProfileHistories.
	Field VendorProfileHistoryOrderField `json:"field"`
}

// VendorProfileHistoryWhereInput is used for filtering VendorProfileHistory objects.
// Input was generated by ent.
...
// Ordering options for VendorProfile connections
...
type VendorProfilePostalAddress struct {
	...
	DeletedAt         *time.Time              `json:"deletedAt,omitempty"`
	DeletedBy         *string                 `json:"deletedBy,omitempty"`
	PostalAddressType enums.PostalAddressType `json:"postalAddressType"`
...
func (VendorProfilePostalAddress) IsNode() {}
...
type VendorProfilePostalAddressConnection struct {
	// A list of edges.
	Edges []*VendorProfilePostalAddressEdge `json:"edges,omitempty"`
	// Information to aid in pagination.
	PageInfo *PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int64 `json:"totalCount"`
...
type VendorProfilePostalAddressCreatePayload struct {
	...
	VendorProfilePostalAddress *VendorProfilePostalAddress `json:"vendorProfilePostalAddress"`
}
...
type VendorProfilePostalAddressEdge struct {
	// The item at the end of the edge.
	Node *VendorProfilePostalAddress `json:"node,omitempty"`
	// A cursor for use in pagination.
	Cursor string `json:"cursor"`
}
...
func (VendorProfilePostalAddressHistory) IsNode() {}

// A connection to a list of items.
type VendorProfilePostalAddressHistoryConnection struct {
	// A list of edges.
	Edges []*VendorProfilePostalAddressHistoryEdge `json:"edges,omitempty"`
	// Information to aid in pagination.
	PageInfo *PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int64 `json:"totalCount"`
...
type VendorProfilePostalAddressHistoryEdge struct {
	// The item at the end of the edge.
	Node *VendorProfilePostalAddressHistory `json:"node,omitempty"`
	// A cursor for use in pagination.
	Cursor string `json:"cursor"`
}

// VendorProfilePostalAddressHistoryWhereInput is used for filtering VendorProfilePostalAddressHistory objects.
// Input was generated by ent.
...
// VendorProfilePostalAddressWhereInput is used for filtering VendorProfilePostalAddress objects.
// Input was generated by ent.
...
// VendorProfileWhereInput is used for filtering VendorProfile objects.
// Input was generated by ent.
...
// Properties by which PostalAddressHistory connections can be ordered.
type PostalAddressHistoryOrderField string

const (
	PostalAddressHistoryOrderFieldRegionCode PostalAddressHistoryOrderField = "region_code"
)

var AllPostalAddressHistoryOrderField = []PostalAddressHistoryOrderField{
	PostalAddressHistoryOrderFieldRegionCode,
}

func (e PostalAddressHistoryOrderField) IsValid() bool {
	switch e {
	case PostalAddressHistoryOrderFieldRegionCode:
		return true
	}
	return false
}

func (e PostalAddressHistoryOrderField) String() string {
	return string(e)
}

func (e *PostalAddressHistoryOrderField) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = PostalAddressHistoryOrderField(str)
	if !e.IsValid() {
...
func (e PostalAddressHistoryOrderField) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

// Properties by which PostalAddress connections can be ordered.
type PostalAddressOrderField string

const (
	PostalAddressOrderFieldRegionCode PostalAddressOrderField = "region_code"
)

var AllPostalAddressOrderField = []PostalAddressOrderField{
	PostalAddressOrderFieldRegionCode,
}

func (e PostalAddressOrderField) IsValid() bool {
	switch e {
	case PostalAddressOrderFieldRegionCode:
		return true
	}
	return false
}

func (e PostalAddressOrderField) String() string {
	return string(e)
}

func (e *PostalAddressOrderField) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = PostalAddressOrderField(str)
	if !e.IsValid() {
...
func (e PostalAddressOrderField) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}
...
// Properties by which VendorHistory connections can be ordered.
type VendorHistoryOrderField string

const (
	VendorHistoryOrderFieldDisplayName     VendorHistoryOrderField = "display_name"
	VendorHistoryOrderFieldVendorType      VendorHistoryOrderField = "vendor_type"
	VendorHistoryOrderFieldOnboardingState VendorHistoryOrderField = "onboarding_state"
)

var AllVendorHistoryOrderField = []VendorHistoryOrderField{
	VendorHistoryOrderFieldDisplayName,
	VendorHistoryOrderFieldVendorType,
	VendorHistoryOrderFieldOnboardingState,
}

func (e VendorHistoryOrderField) IsValid() bool {
	switch e {
	case VendorHistoryOrderFieldDisplayName, VendorHistoryOrderFieldVendorType, VendorHistoryOrderFieldOnboardingState:
		return true
	}
	return false
}

func (e VendorHistoryOrderField) String() string {
	return string(e)
}

func (e *VendorHistoryOrderField) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = VendorHistoryOrderField(str)
	if !e.IsValid() {
...
func (e VendorHistoryOrderField) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

// Properties by which Vendor connections can be ordered.
type VendorOrderField string

const (
	VendorOrderFieldDisplayName     VendorOrderField = "display_name"
	VendorOrderFieldVendorType      VendorOrderField = "vendor_type"
	VendorOrderFieldOnboardingState VendorOrderField = "onboarding_state"
)

var AllVendorOrderField = []VendorOrderField{
	VendorOrderFieldDisplayName,
	VendorOrderFieldVendorType,
	VendorOrderFieldOnboardingState,
}

func (e VendorOrderField) IsValid() bool {
	switch e {
	case VendorOrderFieldDisplayName, VendorOrderFieldVendorType, VendorOrderFieldOnboardingState:
		return true
	}
	return false
}

func (e VendorOrderField) String() string {
	return string(e)
}

func (e *VendorOrderField) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = VendorOrderField(str)
	if !e.IsValid() {
...
func (e VendorOrderField) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

// Properties by which VendorProfileHistory connections can be ordered.
type VendorProfileHistoryOrderField string

const (
	VendorProfileHistoryOrderFieldName VendorProfileHistoryOrderField = "name"
)

var AllVendorProfileHistoryOrderField = []VendorProfileHistoryOrderField{
	VendorProfileHistoryOrderFieldName,
}

func (e VendorProfileHistoryOrderField) IsValid() bool {
	switch e {
	case VendorProfileHistoryOrderFieldName:
		return true
	}
	return false
}

func (e VendorProfileHistoryOrderField) String() string {
	return string(e)
}

func (e *VendorProfileHistoryOrderField) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = VendorProfileHistoryOrderField(str)
	if !e.IsValid() {
...
func (e VendorProfileHistoryOrderField) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

// Properties by which VendorProfile connections can be ordered.
type VendorProfileOrderField string

const (
	VendorProfileOrderFieldName VendorProfileOrderField = "name"
)

var AllVendorProfileOrderField = []VendorProfileOrderField{
	VendorProfileOrderFieldName,
}

func (e VendorProfileOrderField) IsValid() bool {
	switch e {
	case VendorProfileOrderFieldName:
		return true
	}
	return false
}

func (e VendorProfileOrderField) String() string {
	return string(e)
}

func (e *VendorProfileOrderField) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = VendorProfileOrderField(str)
	if !e.IsValid() {
...
func (e VendorProfileOrderField) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}
