...
func TestRateLimiter(t *testing.T) {
	...
	inMemoryStore := NewRateLimiterMemoryStoreWithConfig(RateLimiterMemoryStoreConfig{Rate: 1, Burst: 3})
...
func TestRateLimiterWithConfig_skipper(t *testing.T) {
	...
	inMemoryStore := NewRateLimiterMemoryStore(5)
...
func BenchmarkRateLimiterMemoryStore_1000(b *testing.B) {
	store := NewRateLimiterMemoryStoreWithConfig(RateLimiterMemoryStoreConfig{Rate: 100, Burst: 200, ExpiresIn: testExpiresIn})
