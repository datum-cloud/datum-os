...
const avatarUploadStyles = tv({
  slots: {
    wrapper:
      'relative rounded border-dashed border border-blackberry-800/40 dark:border-blackberry-400 py-5 px-[110px] text-center h-[109px] flex items-center justify-center transition ease-in',
