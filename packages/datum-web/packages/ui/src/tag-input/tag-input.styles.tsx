...
export const tagInputStyles = tv({
  slots: {
    ...
    input:
      'border-none outline-none focus:outline-none focus:ring-0 text-body-m py-0 px-0',
    tag: 'bg-winter-sky-800 dark:bg-peat-800 border-winter-sky-900 text-blackberry-800 py-[7px] px-[10px] rounded-[5px] text-body-m gap-[10px]',
    tagClose: 'text-blackberry-800 dark:text-white p-0',
  },
})
