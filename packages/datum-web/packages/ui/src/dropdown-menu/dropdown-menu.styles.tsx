...
export const dropdownMenuStyles = tv({
  slots: {
    ...
    menuItem:
      'relative flex cursor-default select-none items-center gap-3 rounded-sm p-2 text-button-m outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
    menuCheckboxItem:
