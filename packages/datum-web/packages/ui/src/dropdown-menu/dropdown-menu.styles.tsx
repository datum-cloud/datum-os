...
export const dropdownMenuStyles = tv({
  slots: {
    subTrigger:
      'flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-button-m outline-none focus:bg-accent data-[state=open]:bg-accent',
    ...
    menuItem:
      'relative flex cursor-default select-none items-center gap-3 rounded-sm px-2 py-1.5 text-button-m outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
    menuCheckboxItem:
      'relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-button-m outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
    ...
    menuRadioItemSpan:
      'absolute left-2 flex h-3.5 w-3.5 items-center justify-center',
    menuLabel: 'px-2 py-1.5 text-button-m font-semibold',
